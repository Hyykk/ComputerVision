...
//    void         IntegralImage2(KArrayDWord& arInt, KArrayDWord& arIntSquare) const;
    ...
    KImageGray   Binary4N_Dilate(const int& nType);
    KImageGray   BinaryDilate(const int& nType);
    KImageGray   Binary5x5Dilate(const int& nType);
    KImageGray   Binary4N_Erode(const int& nType);
    KImageGray   BinaryErode(const int& nType);
    KImageGray   Binary5x5Erode(const int& nType);
